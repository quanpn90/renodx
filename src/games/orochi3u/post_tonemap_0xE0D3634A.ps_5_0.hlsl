// ---- Created with 3Dmigoto v1.3.16 on Tue May 27 22:06:00 2025
#include "./common.hlsl"
#include "./shared.h"
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.xyz = float3(1,1,1) + -v2.xyz;
  r1.xyzw = sStage0.Sample(__smpsStage0_s, v3.xy).xyzw;
  r0.xyz = r1.xyz * r0.xyz + v2.xyz;
