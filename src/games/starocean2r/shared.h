...
struct ShaderInjectData {
  ...
  float restore_highlight;
  float restore_highlight_peak;
  float restore_highlight_shoulder;
};
...
#define RESTORE_HIGHLIGHT                          shader_injection.restore_highlight
#define RESTORE_HIGHLIGHT_PEAK                     shader_injection.restore_highlight_peak
#define RESTORE_HIGHLIGHT_SHOULDER                 shader_injection.restore_highlight_shoulder
