...
renodx::mods::shader::CustomShaders custom_shaders = {
    CustomShaderEntry(0x4A87FC29), // final
    CustomShaderEntry(0xB0296070), // main menu 
    CustomShaderEntry(0x3AB6841B), // white ui fix
    CustomShaderEntry(0xB0296070), // character select
