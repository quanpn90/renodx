...
renodx::mods::shader::CustomShaders custom_shaders = {
    ...
    CustomShaderEntry(0x2838FB01),  // output
    CustomShaderEntry(0xF0298A93),  // output
    CustomShaderEntry(0x9C6A6911),  // ui
    // CustomShaderEntry(0x38129360),  // glow
    CustomShaderEntry(0xD57D4B9D),  // main menu tonemapping
    CustomShaderEntry(0x680C78BB),  // tonemapping 
    CustomShaderEntry(0x2FF9D5DD),  // tonemapping 
};
...
extern "C" __declspec(dllexport) constexpr const char* NAME = "RenoDX for Nioh";
