...
#define RENODX_SWAP_CHAIN_ENCODING             4.f // shader_injection.swap_chain_encoding
#define RENODX_SWAP_CHAIN_ENCODING_COLOR_SPACE 1.f // shader_injection.swap_chain_encoding_color_space
