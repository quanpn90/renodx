...
#define DISPLAY_MAP_TYPE                     shader_injection.restore_highlight
#define DISPLAY_MAP_PEAK                     shader_injection.restore_highlight_peak
#define DISPLAY_MAP_SHOULDER                 shader_injection.restore_highlight_shoulder
